...
```{r fig8-clinic-map, echo=FALSE, fig.cap="\\label{fig:fig8-clinic-map}Location of clinics and family physicians in the Hamilton CMA", echo=FALSE, warning=FALSE, message=FALSE, out.width="95%"}
ggmap(basemap) + 
  ...
  theme(legend.position = "bottom") +
  labs(caption = "Map data ©2019 Google")
```
